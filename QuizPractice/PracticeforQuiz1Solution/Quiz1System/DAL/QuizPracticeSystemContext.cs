...
using Quiz1System.Entities;
#endregion
namespace Quiz1System.DAL
{
    internal partial class QuizPracticeSystemContext : DbContext
    {
        public QuizPracticeSystemContext()
            : base("name=QuizPracticeDB")
        {
        }

    ...
    <div class="row">
        <div class="offset 2">
            <blockquote class="alert alert-info">
                ...
                The sample will customize the LisView for columns, titles and enable fields. <br />
                This sample will use HTML5 and .Net validation for input controls.
            </blockquote>
        </div>
    </div>
    <div class="row">
            ...
            <asp:ListView ID="AlbumList" runat="server" 
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #FFFFFF; color: #284775;">
                        ...
                        <td>
                            <asp:Label Text='<%# Eval("AlbumId") %>' runat="server" Width="50px" ID="AlbumIdLabel" /></td>
                        <td>
                            <asp:Label Text='<%# Eval("Title") %>' runat="server" Width="400px" ID="TitleLabel" /></td>
                        <td>
                            <%--<asp:Label Text='<%# Eval("ArtistId") %>' runat="server" ID="ArtistIdLabel" /></td>--%>
                           <%-- Position the dropdown list using the seletedvalue parmetre--%>
                            <asp:DropDownList ID="ArtistIDDD" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField" selectedvalue='<%# Eval("ArtistId") %>' Width="300px" Enabled="false"></asp:DropDownList>
                        <td>
                            <asp:Label Text='<%# Eval("ReleaseYear") %>' runat="server" Width="50px" ID="ReleaseYearLabel" /></td>
                        <td>
                ...
                <EditItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredReleaseYearE" runat="server" 
                        ...
                        ControlToValidate="ReleaseYearTextBoxE" ValidationGroup="egroup"></asp:RequiredFieldValidator>
                    ...
                    <tr style="background-color: #999999;">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("AlbumId") %>' runat="server" Width="50px" ID="AlbumIdTextBox"
                                Enabled="false" /></td>
                        <td>
                            <asp:TextBox Text='<%# Bind("Title") %>' runat="server" Width="400px" ID="TitleTextBoxE" /></td>
                        <td>
                            <%--<asp:TextBox Text='<%# Bind("ArtistId") %>' runat="server" ID="ArtistIdTextBox" /></td>--%>
                            <asp:DropDownList ID="ArtistIDDD" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField" selectedvalue='<%# Bind("ArtistId") %>' Width="300px" ></asp:DropDownList>
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" Width="50px" ID="ReleaseYearTextBoxE" TextMode="Number" step="0.01" min="1950"/></td>
                        <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredTitleE" runat="server" 
                     ...
                     <asp:RequiredFieldValidator ID="RequiredReleaseYearI" runat="server" 
                        ErrorMessage="Release Year is required" Display="None"
                        ControlToValidate="ReleaseYearTextBoxI" ValidationGroup="igroup"></asp:RequiredFieldValidator>
                    ...
                    <tr style="">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("Title") %>' runat="server" Width="400px" ID="TitleTextBoxI" /></td>
                        <td>
                            <%--<asp:TextBox Text='<%# Bind("ArtistId") %>' runat="server" ID="ArtistIdTextBox" /></td>--%>
                            <asp:DropDownList ID="ArtistIDDD" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField" selectedvalue='<%# Bind("ArtistId") %>' Width="300px"></asp:DropDownList>
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" Width="50px" ID="ReleaseYearTextBoxI" TextMode="Number" step="0.01" min="1950" /></td>
                        <td>
                ...
                <SelectedItemTemplate>
                    <tr style="background-color: #E2DED6; font-weight: bold; color: #333333;">
                        ...
                        <td>
                            <%--<asp:Label Text='<%# Eval("ArtistId") %>' runat="server" ID="ArtistIdLabel" /></td>--%>
                            <asp:DropDownList ID="ArtistIDDD" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField"></asp:DropDownList>
                        <td>
